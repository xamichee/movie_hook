...
export default function Header({tabClick, active}) {
  ...
  return (
    <div className="header">
      <div>
        <button className={classSearch} type="button" onClick={tabClick} name="Search">Search</button>
      </div>
      <div>
        <button className={classRated} type="button" onClick={tabClick} name="Rated">Rated</button>
      </div>
    </div>
  )
};
